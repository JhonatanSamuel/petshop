...
export {WhatsappLogo} from '@phosphor-icons/react/dist/ssr';
            ...
            <div className='container mx-auto pt-16 pb-16  px-4 md:pb-0 relative'>
                ...
                <article className='grid grid-cols-1 lg:grid-cols-2 gap-8 '>
                    ...
                    <div className='space-y-6'>
                        ...
                        <a href="#" className="bg-green-500 px-5 py-2 rounded-md gap-2 font-semibold flex items-center justify-center w-fit">
